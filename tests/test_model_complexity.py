...
class TestModelComplexity:
    ...
    def test_compute_complexity_score(self, simple_gp):
        ...
        X = simple_gp.X
        result = gpclarity.compute_complexity_score(simple_gp, X)
